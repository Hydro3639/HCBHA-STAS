...
Step 1, both Illumina short reads and ONT long reads need prepared. e.g., test_S1_1.fastq and test_S1_2.fastq, test_S2_1.fastq and test_S2_2.fastq for short reads 
and test_lr.fastq for long reads
## if your sample was highly sequenced, we strongly suggested you to subsample your data accrodingly. Then store the sequences to the 01-Pre folder
